...
## Suggested output files to keep under version control

Do not commit large PLINK, VCF, or ADMIXTURE binary/output files unless they are small and intentionally included.

Good candidates for GitHub:

```text
docs/genetic_structure_workflow.md
09_feature_integration/fst_summary.R
09_feature_integration/calc_delta.R
09_feature_integration/integrate_fst_delta.R
```

Large/generated files should usually be ignored:
